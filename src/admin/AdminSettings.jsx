...
export default function AdminSettings() {
    ...
    const fetchSettings = async () => {
        try {
            const { data } = await axios.get(`${import.meta.env.VITE_API_URL || "https://backend-d10xvopad-ravi-sahanis-projects.vercel.app/api"}/admin/system-settings`, {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const { data } = await axios.put(
                `${import.meta.env.VITE_API_URL || "https://backend-d10xvopad-ravi-sahanis-projects.vercel.app/api"}/admin/system-settings`,
                formData,
                {
                    headers: {

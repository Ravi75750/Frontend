...
export default function ContestsPage() {
  ...
  const loadContests = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        `${import.meta.env.VITE_API_URL || "https://backend-d10xvopad-ravi-sahanis-projects.vercel.app/api"}/admin/contests`,
        {
  ...
  const deleteContest = async () => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_URL || "https://backend-d10xvopad-ravi-sahanis-projects.vercel.app/api"}/admin/contest/${deleteTarget._id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );

...
export default function UTRModal({ contestId, close, user }) {
  ...
  React.useEffect(() => {
    axios.get(`${import.meta.env.VITE_API_URL || "https://backend-d10xvopad-ravi-sahanis-projects.vercel.app/api"}/admin/system-settings`)
      .then(res => {
  ...
  const sendForm = async (e) => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL || "https://backend-d10xvopad-ravi-sahanis-projects.vercel.app/api"}/payments/submit`, formData, {

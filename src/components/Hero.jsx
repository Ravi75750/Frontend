...
const Hero = () => {
  return (
    ...
    >
      <h1 className="text-5xl  md:text-6xl font-black italic tracking-tighter uppercase self-center drop-shadow-[0_2px_15px_rgba-[#9ce2f9]] text-[#9ce2f9] transition-all duration-300 hover:text-[#ffcc00] hover:drop-shadow-[0_0_20px_rgba(255,69,0,0.8)] leading-tight">
        Ultimate Free Fire Battle!
      </h1>

      <div className="text-[20px] text-[#f88d28] italic tracking-tighter self-center uppercase mt-4 mb-8 max-w-2xl">
        Compete in daily contests and win exciting prizes.
        <p className="mt-2 text-sm text-center">Scroll down to see all contests</p>
